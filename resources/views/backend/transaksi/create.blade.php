        ...
        <table width="100%">
            <tr>
                ...
                <td width="40%" align="right">
                    <p style="margin-top:5px;margin-bottom:5px;font-size:12px;"><span
                            style="font-size:12px;background-color:#3a5c84;color:white;padding:4px;"><b>Faktur</b></span>
                    </p>
                    <p style="margin-top:7px;margin-bottom:8px;font-size:12px;">{{$kode}}</p>
                    <p style="margin-top:17px;margin-bottom:5px;font-size:12px;"><span
                            style="font-size:12px;background-color:#3a5c84;color:white;padding:4px;"><b>Tanggal</b></span>
                    </p>
