                                        ...
                                        <div class="col-md-3">
                                            <div class="input-group">
                                                <select name="status" class="form-control">
                                                    <option value="Semua" @if($status=='Semua' ) selected @endif>Semua
                                                    </option>
                                                    <option value="Lunas" @if($status=='Lunas' ) selected @endif>Lunas
                                                    </option>
                                                    <option value="Belum Lunas" @if($status=='Belum Lunas' ) selected
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="input-group-append">
                                                    ...
                                                    <a class="btn btn-secondary"
                                                        href="{{url('/laporan-labarugi/export?tanggal='.$tgl.'&status='.$status)}}"><i
                                    ...
                                    <table id="list-data" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    {{"Rp " . number_format($row->charge,0,',','.')}}
                                                </td>
                                                <td class="text-right">
                                                    {{"Rp " . number_format($row->laba+$row->charge,0,',','.')}}
                                                </td>
                                            </tr>
                                            @php
                                        ...
                                        <tfoot>
                                            <tr class="text-right">
                                                ...
                                                <th>{{"Rp " . number_format($totalcharge,0,',','.')}}</th>
